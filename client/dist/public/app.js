...
angular.module("app.core").run(["$templateCache", function($templateCache) {$templateCache.put("keypoints/keypoints.tpl.html","<section class=list><div class=ui-container><edit-overlay is-contenteditable=vm.isContenteditable keypoints=vm.keypoints></edit-overlay><navbar></navbar><h3 class=\"list__head text-dark--dark\">All keypoints</h3><keypoint ng-repeat=\"keypoint in vm.keypoints track by $index\" keypoint=keypoint keypoints=vm.keypoints is-contenteditable=vm.isContenteditable show-detail={{true}}></keypoint></div></section>");
...
$templateCache.put("keypoint/keypoint.tpl.html","<div class=\"keypoint ui-card\" ng-class=\"{ \'keypoint--contenteditable\': vm.keypoint.isContenteditable, \'keypoint--preview\': vm.keypoint.contentType === \'image\' }\"><a class=\"kp__head text text-dark--dark u-truncate\" ng-bind=vm.keypoint.topic.title ng-if=vm.showDetail ng-href=http://{{vm.keypoint.topic.url}} target=_blank></a><p class=text-dark--light ng-if=\"vm.keypoint.contentType === \'text\'\" contenteditable=\"{{ vm.keypoint.isContenteditable }}\" ng-class=\"{ \'ui-contenteditabe\': vm.keypoint.isContenteditable }\" ng-model=vm.keypoint.keypoint ng-click=vm.enableContenteditable()></p><p><div class=kp__preview ng-if=\"vm.keypoint.contentType === \'image\'\" ng-style=\"{ \'background-image\': \'url(\' + vm.keypoint.image + \')\' }\"></div><button class=\"kp-btn ui-btn ui-btn--medium ui-btn--success\" ng-if=vm.keypoint.isContenteditable ng-click=vm.updateKeypoint()>update</button></p></div>");
