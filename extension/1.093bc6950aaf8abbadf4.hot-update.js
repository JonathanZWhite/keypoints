...
/***/ function(module, exports, __webpack_require__) {
	...
	var Inject = (function() {
	    ...
	    function _injectIframe() {
	        ...
	        self.iframe.style.cssText = 'position:fixed; top:0; right:0; display: ' + self.getFrameDisplay() + ';' +
	    ...
	    function _toggleFrame() {
	        ...
	        self.iframe.style.cssText = 'position:fixed; top:0; right:0; display:' + self.showFrame + ';' +
	                               'width:350px;height:100%;z-index:1000; border: none;';
	    }
